...
<template>
  <section class="home-tabs my-5">
    <div class="tabs-heading text-center"><div><span >دسته‌بندی‌ها</span><h2 class="text-mainColor">برای قدم‌های راحت‌تر انتخاب کن</h2></div></div>
...
.filters_menu { @apply flex justify-center gap-2 overflow-x-auto p-2 mb-4; scrollbar-width:none; }
