...
.section-kicker {
  @apply block text-sm text-secColor mb-1;
}

.section-heading h2 {
  @apply text-xl sm:text-2xl font-black text-mainColor;
}

.see-all {
  @apply inline-flex items-center gap-1 text-sm text-slate-600 hover:text-secColor transition;
}
