...
<template>
  ...
  <div class=" border-2 rounded-2xl  mx-3 my-2">
    <h5 class="font-bold px-2 mt-4 text-xl text-mainColor">سفارش ها</h5>
    <div class="flex justify-between p-2 border-b">
      <p>در این صفحه میتونی جزیئات خرید های که از ما که کردی رو ببینی</p>

    </div>
    <template v-if="orders == []">

      <UTable v-model:expand="expand" :rows="orders || null" :ui="{ th: { base: 'text-right', }, }">
        <template #expand="{ row }">
          <div class="p-4">
